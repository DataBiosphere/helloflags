...
import bio.terra.helloflags.client.ApiClient;
...
public class HelloflagsClient extends ApiClient {
   ...
   */
  public HelloflagsClient(ServerSpecification server) throws IOException {
    this(server, null);
  }
   ...
   */
  public HelloflagsClient(ServerSpecification server, TestUserSpecification testUser)
      throws IOException {
