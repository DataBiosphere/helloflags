package bio.terra.helloflags.api;
...
import bio.terra.helloflags.config.VersionConfiguration;
import bio.terra.helloflags.controller.PublicApiController;
import bio.terra.helloflags.model.SystemStatus;
import bio.terra.helloflags.service.StatusService;
...
class PublicApiControllerTest {
  ...
  void testVersion() throws Exception {
    ...
    String github = "https://github.com/DataBiosphere/helloflags/tree/0.9.0";
    String build = "0.1.0";
